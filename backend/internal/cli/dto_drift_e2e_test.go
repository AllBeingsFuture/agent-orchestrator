...
func (f *fakeProjectManager) Restore(_ context.Context, id domain.ProjectID) (projectsvc.RestoreResult, error) {
	return projectsvc.RestoreResult{ProjectID: id, Project: projectsvc.Project{ID: id}}, nil
}
